...
//  example
//
//  Created by xuyazhong on 2021/5/21.
//

#import "ViewController.h"
#import <uni_sdk/uni_sdk.h>

#define k_AppId @"__UNI__63A5C2C"
...
- (void)viewDidLoad {
    ...
    [btn setTitle:@"打开uniapp" forState:UIControlStateNormal];
    [btn setTitleColor:UIColor.blueColor forState:UIControlStateNormal];
    [btn addTarget:self action:@selector(openUniMP:) forControlEvents:UIControlEventTouchUpInside];
